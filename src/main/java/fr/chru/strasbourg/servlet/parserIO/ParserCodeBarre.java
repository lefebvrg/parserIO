...
@WebServlet("/parserCodeBarre.view")
public class ParserCodeBarre extends HttpServlet {
	
	private final static Logger logger = Logger.getLogger(ParserCodeBarre.class);
   ...
   */
    ...
    JSONObject infoCodeBarreJSON = null;
		try {
		  IParserIO parserIO = new ParserIO();
